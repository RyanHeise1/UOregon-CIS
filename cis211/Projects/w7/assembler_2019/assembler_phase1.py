    ...
    for lnum in range(len(lines)):
        ...
        try:
            ...
            if fields["kind"] == AsmSrcKind.FULL:
                ...
                log.debug("passing though MEMOP instructions")
                ...
                log.debug("passing though JUMP instructions")
                fix_optional_fields(fields)
                ref = fields["labelref"]
                mem_addr = labels[ref]
                pc_relative = mem_addr - address
                f = fields
                full = f"ADD{f['predicate']} r15,r0,r15[{pc_relative}] #{ref}"
                transformed.append(full)
