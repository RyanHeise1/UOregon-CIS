...
class Context(object):
    ...
    def __init__(self):
        ...
        # r1-r14 are the one we can use in calculations
    ...
    def get_const_symbol(self, value: int) -> str:
        ...
        # appending the value to consts
        # Ex: 42: "const_42" (42 being the value and const_42 being the label)
    ...
    def get_lines(self) -> List[str]:
        ...
        """
        # We make a copy becuase we should not change the state of the Contex object
    ...
    def get_var_symbol(self, name: str) -> str:
        ...
        declare it at the end of the source code.
        """
        # assigning the label with the name (ie: var_x and "x" is the name)
        label = f"var_{name}"
        # Adding label to the dic of vars
    ...
    def allocate_register(self) -> str:
        ...
        free_register(reg).
        """
        # once we use a register (ie: r5) we pop it from the available registers
