...
class Tile(Listenable):
    ...
    def __repr__(self):
        # The '' around self.value makes whatever the value is a string
...
class Board(object):
    ...
    def solve(self):
        ...
        if not self.is_consistent():
            ...
            for can in selected_tile.candidates:
                selected_tile.set_value(can)
                if self.solve():
                    return True
                else:
                    self.set_tiles(copy)
